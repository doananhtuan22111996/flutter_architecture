...
class AppTextTheme {
  ...
  static TextTheme textTheme(AppColors appColors) {
    return TextTheme(
      headline1: _textStyle30.copyWith(
        color: appColors.neutralColor,
        fontWeight: bold,
      ),
      headline2: _textStyle20.copyWith(
        color: appColors.neutralColor,
        fontWeight: bold,
      ),
      subtitle1: _textStyle18.copyWith(
        color: appColors.neutralColor,
        fontWeight: semiBold,
      ),
      subtitle2: _textStyle16.copyWith(
        color: appColors.neutralColor,
        fontWeight: semiBold,
      ),
      bodyText1: _textStyle14.copyWith(
        color: appColors.neutralColor,
        fontWeight: regular,
      ),
      bodyText2: _textStyle12.copyWith(
        color: appColors.neutralColor,
        fontWeight: regular,
      ),
      caption: _textStyle11.copyWith(
        color: appColors.neutralColor,
        fontWeight: regular,
      ),
      overline: _textStyle10.copyWith(
        color: appColors.neutralColor,
        fontWeight: regular,
        letterSpacing: 0,
      ),
