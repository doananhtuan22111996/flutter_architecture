...
class AppFeatureRepositoryImpl extends AppFeatureRepository {
  late final AppNetworkRemoteDataSource _remoteDataSource;
  late final AppFeatureLocalDataSource _localDataSource;

  AppFeatureRepositoryImpl(this._remoteDataSource, this._localDataSource);
