      ...
      title: Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                Icons.search,
                color: AppColors.of.neutralColor[80],
              ),
              labelText: placeholderText,
              fillColor: AppColors.of.neutralColor[0],
              focusColor: AppColors.of.neutralColor[0],
              enabledBorder: OutlineInputBorder(
                borderSide:
                    BorderSide(width: 1, color: AppColors.of.neutralColor[0]!),
                borderRadius: BorderRadius.circular(8),
              ),
